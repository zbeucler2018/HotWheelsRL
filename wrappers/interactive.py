...
Borrowed from: https://github.com/Farama-Foundation/stable-retro/blob/master/retro/examples/interactive.py

Render to video: python3 -m retro.scripts.playback_movie Airstriker-Genesis-Level1-000000.bk2
